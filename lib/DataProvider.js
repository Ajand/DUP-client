...
const DUP_FACTORY_ADDRESS = "0x009f7A49de4fA4b411c1aA1bC653C0b9739d465c";
...
export const DataProvider = ({ children }) => {
  ...
  const getSimpleStorage = useCallback((simpleStorageAddress) => {
    const web3SimpleStorage = new web3.eth.Contract(
      SimpleStorage,
    ...
    const signer = ethersProvider.getSigner();
    const ethersSimpleStorage = new ethers.Contract(
      simpleStorageAddress,
      SimpleStorage,
      signer
    );
    ...
    return {
      web3: web3SimpleStorage,
      ethers: ethersSimpleStorage,
    };
  });
